...
mounted () {
    axios
    .get(`/api/StudentRecord/getAllInactivestudents?pageno=${this.pageno}`)
    .then(response => {
 ...
 methods: {
     clickCallback: function (pageNum) {
         this.pageno = pageNum;
         axios.get(`/api/StudentRecord/getAllInactivestudents?pageno=${this.pageno}`)
        .then(response => {
      ...
      setValueStudent: function(result) {
          alert(result.value)
         axios
       .get(`/api/StudentRecord/getOldStudentByID/${result.value}`)
