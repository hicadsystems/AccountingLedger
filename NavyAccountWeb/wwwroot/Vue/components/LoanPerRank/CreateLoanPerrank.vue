                ...
                <div class="row">
                    ...
                    <div class="col-12 col-xl-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" v-model="postBody.loantype" name="loantype" required :readonly="submitorUpdate == 'Update'">
...
export default {
    ...
    data() {
      ...
      mounted () {
              axios
                    .get('/api/LoanPerRank/getAllLoanType')
    ...
    methods: {
        checkForm: function (e) {
          ...
          this.errors = [];
            this.errors.push('loantype is Required');
          }
        },
        postPost() {

                if(this.submitorUpdate == 'Submit'){
                    axios.post(`/api/LoanPerRank/createLoanPerRank`, this.postBody )
                        .then(response => {
            ...
            if (this.submitorUpdate == 'Update') {
                    axios.put(`/api/LoanPerRank/updateLoanPerRank`, this.postBody )
                        .then(response => {
                            this.responseMessage = response.data.responseDescription;this.canProcess = true;
                            if(response.data.responseCode == '200'){
