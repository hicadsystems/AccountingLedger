                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-xl-2">
                            ...
                            <button class="btn btn-submit btn-primary" v-on:click="printProposal(postBody.schoolname)" type="submit">Export to Pdf</button>
                        </div>
                        <div class="col-12 col-xl-2">
                            <button class="btn btn-submit btn-success" v-on:click="printProposalAsExcel(postBody.schoolname)" type="submit">Export to Excel</button>
                        </div>
