        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    description = table.Column<string>(nullable: true),
                    balsheetid = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fundcode = table.Column<string>(nullable: true),
                    acctcode = table.Column<string>(nullable: true),
                    opbalance = table.Column<string>(nullable: true),
                    adbbalance = table.Column<string>(nullable: true),
                    crbalance = table.Column<string>(nullable: true),
                    balpl = table.Column<string>(nullable: true),
                    createdby = table.Column<string>(nullable: true),
                    datecreated = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
